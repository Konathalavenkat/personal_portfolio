            ...
            <Row style={{paddingBottom:"100px"}}>
                ...
                <Col sm={12} md={8} className="tect-center">
                    ...
                    <Row>
                        ...
                        <Col className="p-1 mx-1 text-center fw-bolder display-card" style={{border:"2px black solid",borderRadius:"10px"}} >Intermediate<br/>Hindustan Junior College<br/>2019-21<br/>Marks: 969/100</Col>
